...
export const filterSlice = createSlice({
  ...
  reducers: {
    ...
    clear(state) {
      ...
      state.size990on2090 = null;
      state.size980on2080 = null;
      state.size960on2060 = null;
      state.size990on2100 = null;
      state.size800on2030 = null;
      state.size800on2030 = null;
      state.size860on2050 = null;
      state.size960on2050 = null;
    ...
    onlySizes(state, action) {
      state.size990on2090 = action.payload.value;
      state.size980on2080 = action.payload.value;
      state.size960on2060 = action.payload.value;
      state.size990on2100 = action.payload.value;
      state.size800on2030 = action.payload.value;
      state.size800on2030 = action.payload.value;
      state.size860on2050 = action.payload.value;
      state.size960on2050 = action.payload.value;
